<?php if (is_single()) : ?>
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<div id="post-content">
			...
			<hr/>
			<p class="text-center"><?php the_time('F jS, Y') ?> | by <?php the_author() ?></p>
			<hr/>
			<?php the_title('<h1 id="post-title">', '</h1>'); ?>
			<?php the_content() ?>
		</div>
		<h3 class="text-center">Read more articles about:</h3>
			<?php
...
<div <?php post_class(); ?>>
	<div class="teaser">		
		<a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_post_thumbnail('featured-teaser'); ?></a>
